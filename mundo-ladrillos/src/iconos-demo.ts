import { iconShofar, iconCoin, iconKey, iconScroll, iconTorch, iconBasket, iconJug, iconStar, iconCord, iconLamp, iconHelmet, iconGrapes, iconShield } from './assets/gameIcons';
